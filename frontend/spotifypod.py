...
UP_KEY_CODE = 8255233 if platform == "darwin" else 116      # 'up arrow' key
DOWN_KEY_CODE = 8320768 if platform == "darwin" else 111    # 'down arrow' key
LEFT_KEY_CODE = 8124162 if platform == "darwin" else 113    # 'left arrow ' key
RIGHT_KEY_CODE = 8189699 if platform == "darwin" else 114   # 'right arrow' key
PREV_KEY_CODE = 2818092 if platform == "darwin" else 33     # 'p' key
NEXT_KEY_CODE = 3080238 if platform == "darwin" else 57     # 'n' key
PLAY_KEY_CODE = 3211296 if platform == "darwin" else 58     # 'm' key
